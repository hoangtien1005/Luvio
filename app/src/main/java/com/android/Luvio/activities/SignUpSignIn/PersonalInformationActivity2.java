...
public class PersonalInformationActivity2 extends AppCompatActivity {
    ...
    private boolean isValidData(){
        ...
        else if(binding.edtRetypePassword.getText().toString().trim().isEmpty()){
            showToast("Chưa nhập mật khẩu nhập lại");
            return false;
        }
        else if(!binding.edtPassword.getText().toString().trim().equals(binding.edtRetypePassword.getText().toString().trim())){
