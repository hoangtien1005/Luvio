...
public class CustomAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        FloatingActionButton likeBtn = (FloatingActionButton) view.findViewById(R.id.like_btn);
        FloatingActionButton infoBtn = (FloatingActionButton) view.findViewById(R.id.info_btn);
        FloatingActionButton messageBtn = (FloatingActionButton) view.findViewById(R.id.message_btn);
